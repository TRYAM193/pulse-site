...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const initBookingForm = () => {
        ...
        const closeSuccessButton = document.getElementById('close-success-overlay');
        if (!form) {
    ...
    const initScrollReveal = () => {
        const revealElements = document.querySelectorAll('.service-card, .testimonial-card, .gallery-item');
